...
class App extends Component {
  ...
  getFilteredQuestions = () => {
    ...
    } else if (selectedLevel === 'ALL' && selectedCategory !== 'ALL') {
      filteredQuestions = questionsData.filter(
        eachQuestion => eachQuestion.language === selectedCategory,
      )
    } else if (selectedLevel !== 'ALL' && selectedCategory === 'ALL') {
      filteredQuestions = questionsData.filter(
        eachQuestion => eachQuestion.difficultyLevel === selectedLevel,
      )
    } else {
      filteredQuestions = questionsData.filter(
        eachQuestion =>
          eachQuestion.language === selectedCategory &&
          eachQuestion.difficultyLevel === selectedLevel,
      )
    }
  ...
  render() {
    ...
    return (
      <div className="bg-container">
        ...
        />
        <div className="bottom-questions-container">
          <Filters
            categoryData={categoryData}
            levelsData={levelsData}
